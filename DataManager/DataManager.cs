...
//  1.28     01/03/18    A Petrescu Calling location microservice story
//  1.29     21/05/18    M Cackett  Added ExecuteDML function needed for DC Improvements 
//                       S Remedios
//
using System;
...
namespace IHF.EnterpriseLibrary.Data
{
    public class DataManager
    {
        ...
        //
        // ExecuteDML - Used to call Insert/Delete/Update SQL statements
        //
        public int ExecuteDML(string databaseMethod, object[] parameters)
        {
                ...
                int result = this._dataAccess.Database.ExecuteNonQuery(command);
        ...
        public IDataReader pipeReader(string databaseMethod, params object[] parameters)
        {
            try
            {
                OracleCommand command = new OracleCommand(databaseMethod);
                ...
                if (parameters != null)
                {
                    parameters.ToList().ForEach(p => command.Parameters.Add("parameter", p));
                }
