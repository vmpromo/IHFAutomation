...
//  1.85     22/05/18    APetrescu Surfaced full call stack when getting exception from printservice
//  1.86     23/05/18    APetrescu Surfaced full call stack when getting exception from printservice
    ...
    public class PackingDAO
    {
        ...
        public PackResponse GenAndPrintDocs(PackRequest req)
        {
            ...
            if (req.ActionId != Enumerations.Action.FT.ToString())
            {
                ...
                {
                    _loggerDAO.LogException(e, Shared.CurrentUser, "DataLoaders.svc");
                    errorMsg = ErrorManager.GetExceptionMessage(e);
